...
module.exports = {
  ...
  async execute(message, args, client, data) {
    if (!message.member.permissions.has(Discord.Permissions.FLAGS.MANAGE_EMOJIS) || client.modRole(message, data.guild)) return client.authorPerms(message, ["BAN_MEMBERS"])
